...
\NewDocumentCommand\sec{mmmmm}{\section{#1}\margindate{#2}{#3}{#4}\label{sec:#5}}
\NewDocumentCommand\subsec{mmmmm}{\subsection{#1}\margindate{#2}{#3}{#4}\label{subsec:#5}}
\NewDocumentCommand\subsubsec{mmmmm}{\subsubsection{#1}\margindate{#2}{#3}{#4}\label{subsubsec:#5}}
